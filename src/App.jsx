    ...
    <div className="bg-signUp ">
      ...
      <div className="lg:bg-[url('./images/bg-curvy-desktop.svg')] lg:w-screen lg:bg-[0_500px] lg:bg-contain lg:bg-no-repeat lg:z-10">
        ...
        <div className="bg-[url('./images/bg-curvy-mobile.svg')] bg-no-repeat bg-[0_310px] w-screen bg-contain lg:transparent ">
          <div className="second lg:second-md">
            <img
        ...
        <div className="bg-main lg:secondBig">
          ...
          <div className="lg:grid lg:grid-cols-[600px_600px] lg:justify-center lg:bg-[#181f2b]">
            <Activity
          ...
          <div className="space-y-10 lg:flex lg:items-center lg:space-y-0">
            <Card
